...
public class ReserverVolView extends JFrame {
	...
	private JComboBox<Aeroport> cbxarrivé;
	...
	public ReserverVolView() {
		...
		cbxarrivé = new JComboBox<Aeroport>();
		cbxarrivé.setBounds(265, 121, 225, 22);
		contentPane.add(cbxarrivé);
	...
	public JComboBox<Aeroport> getCbxarrivé() {
		return cbxarrivé;
	}
	...
	public void setCbxarrivé(JComboBox cbxarrivé) {
		this.cbxarrivé = cbxarrivé;
	}
